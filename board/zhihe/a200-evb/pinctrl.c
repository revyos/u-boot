...
#include <asm/arch-zhxtc9/light-iopmp.h>
#include <memalign.h>
...
int dw_eth_set_txclk_by_speed(u32 speed)
{
	switch (speed) {
...
static void light_wdt0_rst_req(void)
{
	uint32_t data;
