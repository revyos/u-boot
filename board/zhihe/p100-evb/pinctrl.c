...
void gpio_pin_init(void)
{
	...
	gpio_pin_cfg(GPIO0_0, PIN_SPEED_NORMAL, PIN_PN, 0xF);
	gpio_pin_cfg(GPIO0_1, PIN_SPEED_NORMAL, PIN_PN, 0x0);
	gpio_pin_cfg(GPIO0_2, PIN_SPEED_NORMAL, PIN_PN, 0xF);
	gpio_pin_cfg(GPIO0_3, PIN_SPEED_NORMAL, PIN_PN, 0xF);
	gpio_pin_cfg(GPIO0_4, PIN_SPEED_NORMAL, PIN_PN, 0xF);
	gpio_pin_cfg(GPIO0_5, PIN_SPEED_NORMAL, PIN_PN, 0xF);
	gpio_pin_cfg(GPIO0_6, PIN_SPEED_NORMAL, PIN_PN, 0xF);
	gpio_pin_cfg(GPIO0_7, PIN_SPEED_NORMAL, PIN_PN, 0x0);
	gpio_pin_cfg(GPIO0_8, PIN_SPEED_NORMAL, PIN_PN, 0x0);
	gpio_pin_cfg(GPIO0_9, PIN_SPEED_NORMAL, PIN_PN, 0x0);
	gpio_pin_cfg(GPIO0_10, PIN_SPEED_NORMAL, PIN_PN, 0x0);
	gpio_pin_cfg(GPIO0_11, PIN_SPEED_NORMAL, PIN_PN, 0x0);
	...
	gpio_pin_cfg(GPIO0_18, PIN_SPEED_NORMAL, PIN_PN, 0x4);
	gpio_pin_cfg(GPIO0_19, PIN_SPEED_NORMAL, PIN_PN, 0x4);
	gpio_pin_cfg(GPIO0_20, PIN_SPEED_NORMAL, PIN_PN, 0x4);
	gpio_pin_cfg(GPIO0_21, PIN_SPEED_NORMAL, PIN_PN, 0x4);
	gpio_pin_cfg(GPIO0_22, PIN_SPEED_NORMAL, PIN_PN, 0x4);
	gpio_pin_cfg(GPIO0_23, PIN_SPEED_NORMAL, PIN_PN, 0x4);
	...
	gpio_pin_mux(GPIO3_4, 0); // cs1 gpio
	...
	gpio_pin_cfg(GPIO3_2, PIN_SPEED_NORMAL, PIN_PN, 0x4);
	gpio_pin_cfg(GPIO3_4, PIN_SPEED_NORMAL, PIN_PN, 0x4);
	gpio_pin_cfg(GPIO3_5, PIN_SPEED_NORMAL, PIN_PN, 0x4);
	gpio_pin_cfg(GPIO3_6, PIN_SPEED_NORMAL, PIN_PN, 0x4);
	gpio_pin_cfg(GPIO3_7, PIN_SPEED_NORMAL, PIN_PN, 0x4);
	gpio_pin_cfg(GPIO3_8, PIN_SPEED_NORMAL, PIN_PN, 0x4);
