...
//P100 update by DE 85P 20240311{{{
static void de_assert_other_reset_ddr(void)
{
...
static void dwc_ddrphy_phyinit_out_lpddr4_skiptrain_4266(void){
    ...
    //-tt- fix WDQS_on/off violation, porting from soc/p100
...
}//}}}P100:phy_init_skiptrain

//P100:phy_init_skiptrain_related{{{
