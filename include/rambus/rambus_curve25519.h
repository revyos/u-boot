...
/**
  \brief       De-initialize CURVE25519 Interface. stops operation and releases
  the software resources used by the interface \param[in]   curve25519  ecc
...
/**
  ...
  \return      Error code \ref csi_error_t.
*/
csi_error_t csi_curve25519_calc_secret(void *ctx, const uint8_t privkey[32], const uint8_t pubkey[32], uint8_t sk[32],
                                       uint32_t *sk_len);
