...
typedef struct {
    ...
    csi_rsa_crt_t is_crt; /*Enable RSA with CRT*/
    csi_rsa_hash_t is_hash; /*Enable RSA with HASH*/
    csi_rsa_key_bits_t key_bits; /*RSA KEY BITS*/
    csi_rsa_padding_type_t padding_type; /*RSA PADDING TYPE*/
    csi_rsa_hash_type_t hash_type; /*RSA HASH TYPE*/
} csi_rsa_context_t;
...
typedef void (*csi_rsa_callback_t)(csi_rsa_t *rsa, csi_rsa_event_t event,
                                   void *arg); /*Pointer to \ref csi_rsa_callback_t : RSA Event call back.*/

/**
  \brief       Initialize RSA Interface. 1. Initializes the resources needed for
  the RSA interface 2.registers event callback function \param[in]   rsa  RSA
  handle to operate. \param[in]   idx  Device id \return      Error code \ref
  csi_error_t
*/
...
/**
  ...
  software resources used by the interface \param[in]   rsa  RSA handle to
  operate. \return      none
*/
...
/**
  ...
  \return      Error code \ref csi_error_t
*/
csi_error_t csi_rsa_encrypt(csi_rsa_t *rsa, csi_rsa_context_t *context, const void *src, uint32_t src_size, void *out);
...
/**
  ...
  \return      Error code \ref csi_error_t
*/
csi_error_t csi_rsa_decrypt(csi_rsa_t *rsa, csi_rsa_context_t *context, const void *src, uint32_t src_size, void *out,
                            uint32_t *out_size);
...
/**
  ...
  \return      Error code \ref csi_error_t
*/
csi_error_t csi_rsa_sign(csi_rsa_t *rsa, csi_rsa_context_t *context, const void *src, uint32_t src_size,
                         void *signature, csi_rsa_hash_type_t hash_type);
...
*/
bool csi_rsa_verify(csi_rsa_t *rsa, csi_rsa_context_t *context, const void *src, uint32_t src_size, void *signature,
                    uint32_t sig_size, csi_rsa_hash_type_t hash_type);
...
/**
  ...
  \return      Error code \ref csi_error_t
*/
csi_error_t csi_rsa_encrypt_async(csi_rsa_t *rsa, csi_rsa_context_t *context, const void *src, uint32_t src_size,
                                  void *out);
...
/**
  ...
  \return      Error code \ref csi_error_t
*/
csi_error_t csi_rsa_decrypt_async(csi_rsa_t *rsa, csi_rsa_context_t *context, const void *src, uint32_t src_size,
...
/**
  ...
  \return      Error code \ref csi_error_t
*/
csi_error_t csi_rsa_sign_async(csi_rsa_t *rsa, csi_rsa_context_t *context, const void *src, uint32_t src_size,
                               void *signature, csi_rsa_hash_type_t hash_type);
...
/**
  ...
  \return      Verify result
*/
csi_error_t csi_rsa_verify_async(csi_rsa_t *rsa, csi_rsa_context_t *context, const void *src, uint32_t src_size,
                                 void *signature, uint32_t sig_size, csi_rsa_hash_type_t hash_type);
...
*/
csi_error_t csi_rsa_get_publickey(csi_rsa_t *rsa, void *p, uint32_t p_byte_len, void *q, uint32_t q_byte_len, void *out,
                                  csi_rsa_key_bits_t keybits_len);
