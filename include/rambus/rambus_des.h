 ...
 */
typedef enum {
    DES_MASTER_MODE = 0U, /*master mode*/
 ...
 */
typedef enum {
    DES_KEY_LEN_BITS_64 = 0U, /*64 Data bits*/
    TDES_KEY_LEN_BITS_128, /*128 Data bits*/
    TDES_KEY_LEN_BITS_192, /*192 Data bits*/
} csi_des_key_bits_t;
...
/**
  \brief       Initialize DES interface. Initializes the resources needed for
  the DES interface \param[in]   des    Handle to operate \param[in]   idx
  Device id \return      Error code \ref csi_error_t
*/
csi_error_t csi_des_init(csi_des_t *des, uint32_t idx);

/**
  \brief       De-initialize DES interface. Stops operation and releases the
  software resources used by the interface \param[in]   des    Dandle to operate
  \return      None
*/
...
*/
csi_error_t csi_des_set_encrypt_key(csi_des_t *des, const void *key, csi_des_key_bits_t key_len);
...
/**
  ...
  \return      Error code \ref Csi_error_t
*/
csi_error_t csi_des_set_decrypt_key(csi_des_t *des, const void *key, csi_des_key_bits_t key_len);
...
/**
  ...
  \return      Error code \ref Csi_error_t
*/
csi_error_t csi_des_ecb_encrypt(csi_des_t *des, const void *in, void *out, uint32_t size);
...
/**
  ...
  \return      Error code \ref Csi_error_t
*/
csi_error_t csi_des_ecb_decrypt(csi_des_t *des, const void *in, void *out, uint32_t size);
...
/**
  ...
  \return      Error code \ref Csi_error_t
*/
csi_error_t csi_des_cbc_encrypt(csi_des_t *des, const void *in, void *out, uint32_t size, void *iv);
...
/**
  ...
  \return      Error code \ref Csi_error_t
*/
csi_error_t csi_des_cbc_decrypt(csi_des_t *des, const void *in, void *out, uint32_t size, void *iv);
...
/**
  ...
  \return      Error code \ref Csi_error_t
*/
csi_error_t csi_tdes_ecb_encrypt(csi_des_t *des, const void *in, void *out, uint32_t size);
...
/**
  ...
  \return      Error code \ref Csi_error_t
*/
csi_error_t csi_tdes_ecb_decrypt(csi_des_t *des, const void *in, void *out, uint32_t size);
...
/**
  ...
  \return      Error code \ref Csi_error_t
*/
csi_error_t csi_tdes_cbc_encrypt(csi_des_t *des, const void *in, void *out, uint32_t size, void *iv);
...
/**
  ...
  \return      Error code \ref Csi_error_t
*/
csi_error_t csi_tdes_cbc_decrypt(csi_des_t *des, const void *in, void *out, uint32_t size, void *iv);
