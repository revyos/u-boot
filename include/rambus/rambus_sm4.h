...
/**
  ...
  \return      error code \ref uint32_t
*/
csi_error_t csi_sm4_ecb_encrypt(csi_sm4_t *sm4, const uint8_t *in, uint8_t *out, uint32_t size);
...
/**
  ...
  \return      error code \ref uint32_t
*/
csi_error_t csi_sm4_ecb_decrypt(csi_sm4_t *sm4, const uint8_t *in, uint8_t *out, uint32_t size);
...
/**
  ...
  \return      error code \ref uint32_t
*/
csi_error_t csi_sm4_cbc_encrypt(csi_sm4_t *sm4, const uint8_t *in, uint8_t *out, uint32_t size, uint8_t *iv);
...
/**
  ...
  \return      error code \ref uint32_t
*/
csi_error_t csi_sm4_cbc_decrypt(csi_sm4_t *sm4, const uint8_t *in, uint8_t *out, uint32_t size, uint8_t *iv);
...
/**
  ...
  \return      error code \ref uint32_t
*/
csi_error_t csi_sm4_cfb1_encrypt(csi_sm4_t *sm4, const uint8_t *in, uint8_t *out, uint32_t size, uint8_t *iv);
...
/**
  ...
  \return      error code \ref uint32_t
*/
csi_error_t csi_sm4_cfb1_decrypt(csi_sm4_t *sm4, const uint8_t *in, uint8_t *out, uint32_t size, uint8_t *iv);
...
/**
  ...
  \return      error code \ref uint32_t
*/
csi_error_t csi_sm4_cfb8_encrypt(csi_sm4_t *sm4, const uint8_t *in, uint8_t *out, uint32_t size, uint8_t *iv);
...
/**
  ...
  \return      error code \ref uint32_t
*/
csi_error_t csi_sm4_cfb8_decrypt(csi_sm4_t *sm4, const uint8_t *in, uint8_t *out, uint32_t size, uint8_t *iv);
...
/**
  ...
  \return      error code \ref uint32_t
*/
csi_error_t csi_sm4_cfb128_decrypt(csi_sm4_t *sm4, const uint8_t *in, uint8_t *out, uint32_t size, uint8_t *iv,
                                   uint32_t *num);
...
/**
  ...
  \return      error code \ref uint32_t
*/
csi_error_t csi_sm4_cfb128_encrypt(csi_sm4_t *sm4, const uint8_t *in, uint8_t *out, uint32_t size, uint8_t *iv,
                                   uint32_t *num);
/**
  ...
  \return      error code \ref uint32_t
*/
csi_error_t csi_sm4_ofb_encrypt(csi_sm4_t *sm4, const uint8_t *in, uint8_t *out, uint32_t size, uint8_t *iv,
                                uint32_t *num);
...
/**
  ...
  \return      error code \ref uint32_t
*/
csi_error_t csi_sm4_ofb_decrypt(csi_sm4_t *sm4, const uint8_t *in, uint8_t *out, uint32_t size, uint8_t *iv,
                                uint32_t *num);
...
/**
  ...
  \return      error code \ref uint32_t
*/
csi_error_t csi_sm4_ctr_encrypt(csi_sm4_t *sm4, const uint8_t *in, uint8_t *out, uint32_t size,
...
/**
  ...
  \return      error code \ref uint32_t
*/
csi_error_t csi_sm4_ctr_decrypt(csi_sm4_t *sm4, const uint8_t *in, uint8_t *out, uint32_t size,
                                uint8_t nonce_counter[16]);
