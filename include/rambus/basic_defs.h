...
#define CONFIG_RB_DES_DMA_MODE
#define CONFIG_RB_AES_DMA_MODE
#define CONFIG_RB_SM4_DMA_MODE
#define CONFIG_RB_CACHE_DEBUG 1
...
/* modexp crt */
#define EIP150_MODEXPCRT_192_P_OFFSET (0)
#define EIP150_MODEXPCRT_192_Q_OFFSET (0x14 / 4)
#define EIP150_MODEXPCRT_192_DP_OFFSET (0x28 / 4)
#define EIP150_MODEXPCRT_192_DQ_OFFSET (0x34 / 4)
#define EIP150_MODEXPCRT_192_QINV_OFFSET (0x40 / 4)
#define EIP150_MODEXPCRT_192_M_OFFSET (0x54 / 4)

#define EIP150_MODEXPCRT_256_P_OFFSET (0)
#define EIP150_MODEXPCRT_256_Q_OFFSET (0x18 / 4)
#define EIP150_MODEXPCRT_256_DP_OFFSET (0x30 / 4)
#define EIP150_MODEXPCRT_256_DQ_OFFSET (0x40 / 4)
#define EIP150_MODEXPCRT_256_QINV_OFFSET (0x50 / 4)
#define EIP150_MODEXPCRT_256_M_OFFSET (0x68 / 4)

#define EIP150_MODEXPCRT_512_P_OFFSET (0)
#define EIP150_MODEXPCRT_512_Q_OFFSET (0x28 / 4)
#define EIP150_MODEXPCRT_512_DP_OFFSET (0x50 / 4)
#define EIP150_MODEXPCRT_512_DQ_OFFSET (0x70 / 4)
#define EIP150_MODEXPCRT_512_QINV_OFFSET (0x90 / 4)
#define EIP150_MODEXPCRT_512_M_OFFSET (0xE0 / 4)

#define EIP150_MODEXPCRT_1024_P_OFFSET (0)
#define EIP150_MODEXPCRT_1024_Q_OFFSET (0x48 / 4)
#define EIP150_MODEXPCRT_1024_DP_OFFSET (0x90 / 4)
#define EIP150_MODEXPCRT_1024_DQ_OFFSET (0xd0 / 4)
#define EIP150_MODEXPCRT_1024_QINV_OFFSET (0x110 / 4)
#define EIP150_MODEXPCRT_1024_M_OFFSET (0x158 / 4)

#define EIP150_MODEXPCRT_2048_P_OFFSET (0)
#define EIP150_MODEXPCRT_2048_Q_OFFSET (0x88 / 4)
#define EIP150_MODEXPCRT_2048_DP_OFFSET (0x110 / 4)
#define EIP150_MODEXPCRT_2048_DQ_OFFSET (0x190 / 4)
#define EIP150_MODEXPCRT_2048_QINV_OFFSET (0x210 / 4)
#define EIP150_MODEXPCRT_2048_M_OFFSET (0x298 / 4)

#define EIP150_MODEXPCRT_3072_P_OFFSET (0)
#define EIP150_MODEXPCRT_3072_Q_OFFSET (0xc8 / 4)
#define EIP150_MODEXPCRT_3072_DP_OFFSET (0x190 / 4)
#define EIP150_MODEXPCRT_3072_DQ_OFFSET (0x250 / 4)
#define EIP150_MODEXPCRT_3072_QINV_OFFSET (0x310 / 4)
#define EIP150_MODEXPCRT_3072_M_OFFSET (0x3D8 / 4)

#define EIP150_MODEXPCRT_4096_P_OFFSET (0)
#define EIP150_MODEXPCRT_4096_Q_OFFSET (0x108 / 4)
#define EIP150_MODEXPCRT_4096_DP_OFFSET (0x210 / 4)
#define EIP150_MODEXPCRT_4096_DQ_OFFSET (0x310 / 4)
#define EIP150_MODEXPCRT_4096_QINV_OFFSET (0x410 / 4)
#define EIP150_MODEXPCRT_4096_M_OFFSET (0x519 / 4)
...
/* dsa sha1 sign */
#define EIP150_DSA_SHA1_P_OFFSET 0 /*group param*/
#define EIP150_DSA_SHA1_D_OFFSET (0x130 / 4) /*private*/
#define EIP150_DSA_SHA1_E_OFFSET (0x148 / 4) /*hash digest*/
#define EIP150_DSA_SHA1_K_OFFSET (0x160 / 4) /*random*/
#define EIP150_DSA_SHA1_R_OFFSET (0x160 / 4)
#define EIP150_DSA_SHA1_S_OFFSET (0x180 / 4)

/* dsa sha1 verify */
#define EIP150_DSA_SHA1_V_P_OFFSET 0
#define EIP150_DSA_SHA1_V_PUB_OFFSET (0x130 / 4)
#define EIP150_DSA_SHA1_V_E_OFFSET (0x1B0 / 4)
#define EIP150_DSA_SHA1_V_R_OFFSET (0x1C8 / 4)
#define EIP150_DSA_SHA1_V_S_OFFSET (0x1E8 / 4)

/* dsa sha224 sign */
#define EIP150_DSA_SHA224_P_OFFSET 0 /*group param*/
#define EIP150_DSA_SHA224_D_OFFSET (0x230 / 4) /*private*/
#define EIP150_DSA_SHA224_E_OFFSET (0x250 / 4) /*hash digest*/
#define EIP150_DSA_SHA224_K_OFFSET (0x270 / 4) /*random*/
#define EIP150_DSA_SHA224_R_OFFSET (0x270 / 4)
#define EIP150_DSA_SHA224_S_OFFSET (0x298 / 4)

/* dsa sha224 verify */
#define EIP150_DSA_SHA224_V_P_OFFSET 0
#define EIP150_DSA_SHA224_V_PUB_OFFSET (0x230 / 4)
#define EIP150_DSA_SHA224_V_E_OFFSET (0x330 / 4)
#define EIP150_DSA_SHA224_V_R_OFFSET (0x350 / 4)
#define EIP150_DSA_SHA224_V_S_OFFSET (0x378 / 4)

/* dsa sha256 sign */
#define EIP150_DSA_SHA256_P_OFFSET 0 /*group param*/
#define EIP150_DSA_SHA256_D_OFFSET (0x230 / 4) /*private*/
#define EIP150_DSA_SHA256_E_OFFSET (0x250 / 4) /*hash digest*/
#define EIP150_DSA_SHA256_K_OFFSET (0x270 / 4) /*random*/
#define EIP150_DSA_SHA256_R_OFFSET (0x270 / 4)
#define EIP150_DSA_SHA256_S_OFFSET (0x298 / 4)

/* dsa sha256 verify */
#define EIP150_DSA_SHA256_V_P_OFFSET 0
#define EIP150_DSA_SHA256_V_PUB_OFFSET (0x230 / 4)
#define EIP150_DSA_SHA256_V_E_OFFSET (0x330 / 4)
#define EIP150_DSA_SHA256_V_R_OFFSET (0x350 / 4)
#define EIP150_DSA_SHA256_V_S_OFFSET (0x378 / 4)

/* ecp_mul */ //todo check
#define EIP150_ECP_MUL_V_P_OFFSET 0
#define EIP150_ECP_MUL_V_K_OFFSET (0x78 / 4) //(0xC8 / 4)
#define EIP150_ECP_MUL_V_PUB_OFFSET (0x98 / 4) //(0x78 / 4)
#define EIP150_ECP_MUL_V_D_OFFSET (0xE8 / 4) //(0xE8 / 4)

/* ecmont_mul */
#define EIP150_ECMONT_MUL_V_P_OFFSET 0
#define EIP150_ECMONT_MUL_V_K_OFFSET (0x50 / 4)
#define EIP150_ECMONT_MUL_V_PUB_OFFSET (0x70 / 4)
#define EIP150_ECMONT_MUL_V_D_OFFSET (0x98 / 4)

#define EIP28_FUNCTION_SEQ_SM2_SIGN (uint32_t)((0x04 << 12) | BIT_17)
#define EIP28_FUNCTION_SEQ_SM2_VERIFY (uint32_t)((0x05 << 12) | BIT_17)

#define EIP28_FUNCTION_SEQ_EC_SIGN (uint32_t)((0x02 << 12) | BIT_17)
#define EIP28_FUNCTION_SEQ_EC_VERIFY (uint32_t)((0x03 << 12) | BIT_17)

#define EIP28_FUNCTION_SEQ_DSA_SIGN (uint32_t)((0x0 << 12) | BIT_17)
#define EIP28_FUNCTION_SEQ_DSA_VERIFY (uint32_t)((0x1 << 12) | BIT_17)

#define EIP28_FUNCTION_SEQ_ECP_ADD (uint32_t)((0x03 << 12))
#define EIP28_FUNCTION_SEQ_ECP_ADD_XYZ (uint32_t)((0x00 << 12) | BIT_16)
#define EIP28_FUNCTION_SEQ_ECP_MUL (uint32_t)((0x05 << 12))
#define EIP28_FUNCTION_SEQ_ECP_MUL_XYZ (uint32_t)((0x01 << 12) | BIT_16)
#define EIP28_FUNCTION_SEQ_ECP_SCALE_XYZ (uint32_t)((0x02 << 12) | BIT_16)

#define EIP28_FUNCTION_SEQ_MODEXP_CRT (uint32_t)((0x01 << 12) | BIT_15)
...
#define EIP120_CRYPTO_KEY2_0 0x500
#define EIP120_CRYPTO_KEY2_1 0x504
#define EIP120_CRYPTO_KEY2_2 0x508
#define EIP120_CRYPTO_KEY2_3 0x50C
#define EIP120_CRYPTO_KEY3_0 0x510
#define EIP120_CRYPTO_KEY3_1 0x514
#define EIP120_CRYPTO_KEY3_2 0x518
#define EIP120_CRYPTO_KEY3_3 0x51c
...
#define EIP120_CRYPTO_RANDOM 0x570
...
#define EIP120_HASH_DATA_IN_16 0x640
#define EIP120_HASH_DATA_IN_17 0x644
#define EIP120_HASH_DATA_IN_18 0x648
#define EIP120_HASH_DATA_IN_19 0x64C
#define EIP120_HASH_DATA_IN_20 0x650
#define EIP120_HASH_DATA_IN_21 0x654
#define EIP120_HASH_DATA_IN_22 0x658
#define EIP120_HASH_DATA_IN_23 0x65C
#define EIP120_HASH_DATA_IN_24 0x660
#define EIP120_HASH_DATA_IN_25 0x664
#define EIP120_HASH_DATA_IN_26 0x668
#define EIP120_HASH_DATA_IN_27 0x66C
#define EIP120_HASH_DATA_IN_28 0x670
#define EIP120_HASH_DATA_IN_29 0x674
#define EIP120_HASH_DATA_IN_30 0x678
#define EIP120_HASH_DATA_IN_31 0x67C
#define EIP120_HASH_DATA_IN_32 0x680
#define EIP120_HASH_DATA_IN_33 0x684
#define EIP120_HASH_DATA_IN_34 0x688
#define EIP120_HASH_DATA_IN_35 0x68C
...
#define EIP120_HASH_DIGEST_INOUT_I 0x6B0
#define EIP120_HASH_DIGEST_INOUT_J 0x6B4
#define EIP120_HASH_DIGEST_INOUT_K 0x6B8
#define EIP120_HASH_DIGEST_INOUT_L 0x6BC
#define EIP120_HASH_DIGEST_INOUT_M 0x6C0
#define EIP120_HASH_DIGEST_INOUT_N 0x6C4
#define EIP120_HASH_DIGEST_INOUT_O 0x6C8
#define EIP120_HASH_DIGEST_INOUT_P 0x6CC
#define EIP120_HASH_DIGEST_INOUT_SHA3 0x6D0
...
#define DES_DIR_BIT BIT_2
#define DES_BLOCK_SIZE_IN_BYTE 8
...
/* TEE */
#define TEE_EFUSE_CVCON1_PRELD_3 0x5C
#define EIP_120SI_SCA_MASK (BIT_16 | BIT_17)
#define EIP_120SII_SCA_MASK (BIT_18 | BIT_19)
#define EIP_150_SCA_MASK (BIT_20 | BIT_21)
