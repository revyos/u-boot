...
typedef void (*csi_ecc_callback_t)(csi_ecc_event_e event);
...
/**
  ...
  \return      Error code \ref csi_error_t
*/
csi_error_t csi_ecc_config(csi_ecc_t *ecc, csi_ecc_cipher_order_e co, csi_ecc_endian_mode_e endian);
...
/**
  \brief       ecc get capability.
  \param[in]   ecc  Operate handle.
  \param[out]  cap  Pointer of csi_ecc_capabilities_t.
  \return      Error code Error code \ref csi_error_t
*/
csi_error_t csi_ecc_get_capabilities(csi_ecc_t *ecc, csi_ecc_capabilities_t *cap);
...
/**
  ...
  \return      Error code \ref csi_error_t
*/
csi_error_t csi_ecc_encrypt(csi_ecc_t *ecc, uint8_t *Plain, uint32_t PlainByteLen, uint8_t pubKey[65], uint8_t *Cipher,
...
/**
  ...
  \return      Error code \ref csi_error_t
*/
csi_error_t csi_ecc_decrypt(csi_ecc_t *ecc, uint8_t *Cipher, uint32_t CipherByteLen, uint8_t prikey[32], uint8_t *Plain,
...
/**
  ...
  \return      Error code \ref csi_error_t
*/
csi_error_t csi_ecc_exchangekey(csi_ecc_t *ecc, ecc_exchange_role_e role, uint8_t *dA, uint8_t *PB, uint8_t *rA,
...
/**
  ...
  \return      Error code Error code \ref csi_error_t
*/
csi_error_t csi_ecc_getZ(csi_ecc_t *ecc, uint8_t *ID, uint32_t byteLenofID, uint8_t pubKey[65], uint8_t Z[32]);
...
/**
  ...
  \return      Error code Error code \ref csi_error_t
*/
csi_error_t csi_ecc_getE(csi_ecc_t *ecc, uint8_t *M, uint32_t byteLen, uint8_t Z[32], uint8_t E[32]);
