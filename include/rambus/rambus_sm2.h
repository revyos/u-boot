 ...
 */
typedef enum { SM2_Role_Sponsor = 0, SM2_Role_Responsor } csi_sm2_exchange_role_e;
...
typedef void (*csi_sm2_callback_t)(csi_sm2_event_e event);
...
/**
  ...
  \return      \ref uint32_t
*/
csi_error_t csi_sm2_config(csi_sm2_t *sm2, csi_sm2_cipher_order_e co, csi_sm2_endian_mode_e endian);
...
/**
  \brief       sm2 get capability.
  \param[in]   sm2  Operate handle.
  \param[out]  cap  Pointer of csi_sm2_capabilities_t.
  \return      Error code \ref csi_error_t
*/
csi_error_t csi_sm2_get_capabilities(csi_sm2_t *sm2, csi_sm2_capabilities_t *cap);
...
/**
  ...
  \return      Error code \ref csi_error_t
*/
csi_error_t csi_sm2_encrypt(csi_sm2_t *sm2, uint8_t *Plain, uint32_t PlainByteLen, uint8_t pubKey[65], uint8_t *Cipher,
...
/**
  ...
  \return      Error code \ref csi_error_t
*/
csi_error_t csi_sm2_decrypt(csi_sm2_t *sm2, uint8_t *Cipher, uint32_t CipherByteLen, uint8_t prikey[32], uint8_t *Plain,
                            uint32_t *PlainByteLen);
...
/**
  ...
  \return      Error code \ref csi_error_t
*/
csi_error_t csi_sm2_exchangekey(csi_sm2_t *sm2, csi_sm2_exchange_role_e role, uint8_t *dA, uint8_t *PB, uint8_t *rA,
                                uint8_t *RA, uint8_t *RB, uint8_t *ZA, uint8_t *ZB, uint32_t kByteLen, uint8_t *KA,
...
/**
  ...
  \return      Error code \ref csi_error_t
*/
csi_error_t csi_sm2_getZ(csi_sm2_t *sm2, uint8_t *ID, uint32_t byteLenofID, uint8_t pubKey[65], uint8_t Z[32]);
...
/**
  ...
  \return      Error code \ref csi_error_t
*/
csi_error_t csi_sm2_getE(csi_sm2_t *sm2, uint8_t *M, uint32_t byteLen, uint8_t Z[32], uint8_t E[32]);
